  ...
  describe 'test' do
    before(:each) do
      @first_user = User.create(name: 'Tom', photo: 'https://images.pexels.com/photos/1181667/pexels-photo-1181667',
                                bio: 'I am the sunny at Frye Elementary. I moved to Arizona in 1993 from Oregon
and never looked back, despite the hot, dry Arizona summers.
...
My husband, Patrick and I live in Ahwatukee with our daughter, Reagan and our three cats.')
 ...
 Her theory of the two mindsets and the difference they make in outcomes is incredibly powerful.')
      ...
      @second_post = Post.create(author: @first_user, title: 'Time Management',
                                 text: 'While some people are able to power through the day, maintaining focus
and accomplishing their goals, time management is an area where most of us tend to struggle.
 ...
 organization empowering people in need by providing technology
 education and counseling through various national, state, and local
 collaboration projects and partnerships in order to help those
 individuals reach their professional and personal goals free of charge')
